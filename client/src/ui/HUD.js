export function createHUD(scene, tier, config) {
  ...
  scene.add.text(36, 55, `AI: ${config.aggressionLevel.toUpperCase()} | ACCURACY ${Math.round(config.aimAccuracy * 100)}% | [WASD] MOVE [SPACE] FIRE`, { fontFamily: 'monospace', fontSize: '11px', color: '#70e6c1' }).setDepth(11);
